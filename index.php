                        ...
                        <div class="banner-slide slide-1">
                            <div class="containerFull w-100">
                                <div class="slide_inner">
                                    <small class="title fontWeight700 text-white-50 fade-up fade-up-1">
                                        HEALTH CARE SERVICES
                                    </small>
                                    <div>
                                        <h1
                                            class="mt-4 fontHeading heading fontWeight700 text-center fade-up fade-up-2">
                                            <span class="text_primary">Because every life deserves care,</span> <br />
                                            <span class="text_secondary">comfort, and a second bloom.</span>
                                        </h1>
                                        <div class="d-flex justify-content-center">
                                            <p class="mt-3 fontWeight500 w-50 text-center fade-up fade-up-3">
                                        ...
                                        <div class="mt-5 d-flex justify-content-center gap-2 fade-up fade-up-4">
